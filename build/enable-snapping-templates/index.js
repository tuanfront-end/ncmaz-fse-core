...
/***/ "./src/enable-snapping-templates/index.tsx":
/*!*************************************************!*\
  !*** ./src/enable-snapping-templates/index.tsx ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/query-pagination-next.js");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./style.scss */ "./src/enable-snapping-templates/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./editor.scss */ "./src/enable-snapping-templates/editor.scss");
...
function addAttributes(settings) {
  if ("ncmfse/term-template" !== settings.name && "core/post-template" !== settings.name) {
    return settings;
  }
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__.addFilter)("blocks.registerBlockType", "enable-snapping-templates/add-attributes", addAttributes);
...
function addInspectorControls(BlockEdit) {
  return props => {
    if (props.name !== "ncmfse/term-template" && props.name !== "core/post-template") {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockEdit, {
      ...
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Horizontal Scroll Snapping"),
      onClick: () => setIsEditingURL(true),
      isActive: !!isHorizontalScrollSnapping
    }), isEditingURL && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Popover, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Show Scrollbar"),
      checked: showScrollbar,
      onChange: newValue => {
        setAttributes({
          showScrollbar: newValue
        });
      }
    })))));
  };
}
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__.addFilter)("editor.BlockEdit", "enable-snapping-templates/add-inspector-controls", addInspectorControls);
...
function addClasses(BlockListBlock) {
  return props => {
    ...
    const classes = (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])(props?.className, {
      "is-h-scroll-snapping": attributes.isHorizontalScrollSnapping,
      "hidden-scrollbar": attributes.isHorizontalScrollSnapping && !attributes.showScrollbar
    });
    const wrapperProps = {
      ...props.wrapperProps,
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__.addFilter)("editor.BlockListBlock", "enable-snapping-templates/add-classes", addClasses);

/***/ }),

/***/ "./src/enable-snapping-templates/editor.scss":
/*!***************************************************!*\
  !*** ./src/enable-snapping-templates/editor.scss ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/enable-snapping-templates/style.scss":
/*!**************************************************!*\
  !*** ./src/enable-snapping-templates/style.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"enable-snapping-templates/index": 0,
/******/ 			"enable-snapping-templates/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["enable-snapping-templates/style-index"], () => (__webpack_require__("./src/enable-snapping-templates/index.tsx")))
