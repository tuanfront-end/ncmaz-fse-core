...
/***/ "./src/saved-post-template-block/edit.tsx":
/*!************************************************!*\
  !*** ./src/saved-post-template-block/edit.tsx ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/list.js");
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./editor.scss */ "./src/saved-post-template-block/editor.scss");
/* harmony import */ var _hooks_utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../hooks/utils */ "./src/hooks/utils.ts");
...
const MemoizedPostTemplateBlockPreview = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.memo)(PostTemplateBlockPreview);
function PostTemplateEdit({
  ...
  const blockContexts = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => posts?.map(post => {
  ...
  const {
    postTypesSelectOptions
  } = (0,_hooks_utils__WEBPACK_IMPORTED_MODULE_9__.usePostTypes)();
  ...
  if (!posts) {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
      ...blockProps
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Spinner, null));
  }
  if (!posts.length) {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
      ...blockProps
    }, " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("No results found."));
  }
  ...
  const displayLayoutControls = [{
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("List view", "Post template block display setting"),
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._x)("Grid view", "Post template block display setting"),
    onClick: () => setDisplayLayout({
      type: "grid",
      columnCount
    }),
  ...
  const postTypeControlHelp = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Limit results to taxonomies associated with a specific post type.");

  // To avoid flicker when switching active block contexts, a preview is rendered
  // for each block context, but the preview for the active block context is hidden.
  // This ensures that when it is displayed again, the cached rendering of the
  // block preview is used, instead of having to re-render the preview from scratch.
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ToolbarGroup, {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Filter", "ncmfse")
  }, postTypesSelectOptions.length > 2 ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.SelectControl, {
    __nextHasNoMarginBottom: true,
    __next40pxDefaultSize: true,
    options: postTypesSelectOptions,
    value: postType,
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Post type"),
    ...
    help: postTypeControlHelp
  }, postTypesSelectOptions.map(option => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.__experimentalToggleGroupControlOption, {
    key: option.value,
    value: option.value,
    label: option.label
...
/***/ "./src/saved-post-template-block/index.tsx":
/*!*************************************************!*\
  !*** ./src/saved-post-template-block/index.tsx ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/saved-post-template-block/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/saved-post-template-block/edit.tsx");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/saved-post-template-block/save.tsx");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/saved-post-template-block/block.json");
/**
...
/***/ "./src/saved-post-template-block/save.tsx":
/*!************************************************!*\
  !*** ./src/saved-post-template-block/save.tsx ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/saved-post-template-block/editor.scss":
/*!***************************************************!*\
  !*** ./src/saved-post-template-block/editor.scss ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/saved-post-template-block/style.scss":
/*!**************************************************!*\
  !*** ./src/saved-post-template-block/style.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"saved-post-template-block/index": 0,
/******/ 			"saved-post-template-block/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["saved-post-template-block/style-index"], () => (__webpack_require__("./src/saved-post-template-block/index.tsx")))
