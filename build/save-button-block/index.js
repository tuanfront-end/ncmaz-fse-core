...
function Edit(props) {
  ...
  const colorSettings = [{
    ...
    resetAllFilter: () => {
      ...
      setAttributes({
        customActiveIconBgColor: "#e4e4e794"
      });
    }
  }];
