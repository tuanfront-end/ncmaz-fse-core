...
/***/ "./src/post-format-icon-block/edit.tsx":
/*!*********************************************!*\
  !*** ./src/post-format-icon-block/edit.tsx ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./src/post-format-icon-block/editor.scss");
...
/***/ "./src/post-format-icon-block/index.tsx":
/*!**********************************************!*\
  !*** ./src/post-format-icon-block/index.tsx ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/post-format-icon-block/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/post-format-icon-block/edit.tsx");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/post-format-icon-block/block.json");
...
/***/ "./src/post-format-icon-block/editor.scss":
/*!************************************************!*\
  !*** ./src/post-format-icon-block/editor.scss ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/post-format-icon-block/style.scss":
/*!***********************************************!*\
  !*** ./src/post-format-icon-block/style.scss ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/post-format-icon-block/block.json":
/*!***********************************************!*\
  !*** ./src/post-format-icon-block/block.json ***!
  \***********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ncmfse/post-format-icon","version":"0.1.0","title":"Ncmaz Post Format Icon","category":"ncmfse","usesContext":["postId","postType"],"description":"Example block scaffolded with Create Block tool.","ancestor":["core/post-template"],"example":{},"attributes":{},"supports":{"anchor":false,"html":false,"color":{"gradients":true,"__experimentalDefaultControls":{"background":true,"text":true}},"typography":{"fontSize":true,"lineHeight":true,"__experimentalFontFamily":true,"__experimentalFontWeight":true,"__experimentalFontStyle":true,"__experimentalTextTransform":true,"__experimentalTextDecoration":true,"__experimentalLetterSpacing":true,"__experimentalWritingMode":true,"__experimentalDefaultControls":{"fontSize":true}},"shadow":true,"spacing":{"padding":true,"margin":true,"blockGap":true,"__experimentalDefaultControls":{"padding":true,"blockGap":true}},"__experimentalBorder":{"color":true,"radius":true,"style":true,"width":true,"__experimentalDefaultControls":{"color":true,"radius":true,"style":true,"width":true}}},"textdomain":"ncmfse","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');
...
/******/ 		var installedChunks = {
/******/ 			"post-format-icon-block/index": 0,
/******/ 			"post-format-icon-block/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["post-format-icon-block/style-index"], () => (__webpack_require__("./src/post-format-icon-block/index.tsx")))
